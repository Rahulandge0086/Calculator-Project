    ...
    document.querySelectorAll(".but")[y].addEventListener("click",function(event){
      ...
      if(this.innerHTML != "*" && this.innerHTML != "+" && this.innerHTML != "/" && this.innerHTML != "-" && this.innerHTML != "%" && this.innerHTML != "(-")
      {
         ...
         if(TriSet>=1)
         {
            if(TriEqu == 1)
               {
                  if(m==0){document.querySelector(".ioBox").innerHTML = "sin("+temp_n+"&nbsp&nbsp&nbsp";}
                  else{document.querySelector(".ioBox").innerHTML = "sin("+-temp_n+"&nbsp&nbsp&nbsp";}
                  
               }
               else if(TriEqu == 2)
               {
                  if(m==0){document.querySelector(".ioBox").innerHTML = "cos("+temp_n+"&nbsp&nbsp&nbsp";}
                  else{document.querySelector(".ioBox").innerHTML = "cos("+-temp_n+"&nbsp&nbsp&nbsp";}
               }
               else if(TriEqu == 3)
               {
                  if(m==0){document.querySelector(".ioBox").innerHTML = "tan("+temp_n+"&nbsp&nbsp&nbsp";}
                  else{document.querySelector(".ioBox").innerHTML = "tan("+-temp_n+"&nbsp&nbsp&nbsp";}
               }
         }
         else{
            if(m == 0)
